 ...
 * @author Xrysa
 *
 * MenuItem is used by a Menu object to map a menu option to a target method.
 * With the use of reflection MenuItem is able to invoke the target. The object
 * where the target resides is also provided and this allows for a method in any
 * Object to be invoked for a MenuItem. Each Menu object will also have a
 * MenuItem instance used to define an exit option in the menu. This will be a
 * 'dummy' MenuItem meaning it cannot be invoked but is simply used as a
 * identifier.
 */
